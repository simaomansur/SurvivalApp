...
class ProfileFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //change textview to name
        val nameText = view?.findViewById<TextView>(R.id.nav_name2)
        nameText?.text = "Name: $name"

        //get email from viewmodel
        val email = view?.findViewById<TextView>(R.id.nav_email2)
        email?.text = "Email: ${model.getEmail()}"
